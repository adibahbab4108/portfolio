...
const Hero = () => {
    return (
        <section className=" h-[calc(100vh-66px)] flex flex-col justify-center  text-white px-6 ">
            <div className="flex flex-col md:flex-row items-center gap-12 mt-60 md:mt-0">
                {/* Left Content */}
                ...
                <div className="">
                    ...
                    lg:w-[30rem] lg:h-[30rem]
                      ...
                      brightness-70 hover:brightness-90
                       rotate-6 hover:rotate-0 transition-all duration-1000">
                        <img
                            src={myProfile}
                            alt="adibahbab4108"
            ...
            {/* Stats Section */}
            <div className="mt-12 flex flex-wrap justify-evenly gap-8 mb-80 md:mb-2">
