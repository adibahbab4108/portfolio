...
const Projects = () => {
    ...
    return (
        <div id="projects">
            ...
            <div className={`grid grid-cols-1 ${showProjectDetails ? `md:grid-cols-1 h ` : `md:grid-cols-2`}  gap-10 md:gap-20 lg:gap-40`}>
                {
                    !showProjectDetails ? projects.map((project, idx) => {
                        ...
                        <>
                            <div className=" bg-slate-900 text-white p-6 rounded-2xl shadow-lg  hover:shadow-xl group">
